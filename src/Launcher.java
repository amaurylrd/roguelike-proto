...
public class Launcher extends Application {
    public static void main(String[] args) {
        ...
        java.util.List<cl_device_id> devices = new java.util.ArrayList<cl_device_id>();
        for (int i = 0; i < platforms.length; i++) {
            ...
            devices.addAll(java.util.Arrays.asList(devicesArray));
        }
    ...
    static long[] getSizes(cl_device_id device, int paramName, int numValues) {
        ...
        java.nio.ByteBuffer buffer = java.nio.ByteBuffer.allocate(numValues * Sizeof.size_t)
