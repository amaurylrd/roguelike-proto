...
In case you need the latest stable version or whatever, follow this [url]( jogamp.org/deployment/v2.4.0-rc-20210111/fat/jogamp-fat.jar) to get the latest aggregated autobuild and download the archive *jogamp-all-platforms* containing all the Jogamp jars, native libraries and sources.
