...
In case you need the latest stable version or whatever, follow this [url](https://jogamp.org/deployment/v2.4.0-rc-20200115/jar) to get the most recent aggregated autobuild and download the archive *jogamp-all-platforms* containing all the Jogamp jars, native libraries and sources.
